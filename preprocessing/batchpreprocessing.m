function result = batchpreprocessing(inDir, outDir)
%batchpreprocessing Batch process images using preprocessing
% RESULT = batchpreprocessing(INDIR, OUTDIR) processes each file in INDIR
% using the function preprocessing.
%
% The following fields from the output of preprocessing are written with their
...
if(nargin<1)
    inDir = 'C:\Users\holstein\Downloads\user_training_test_data_example_products\user_training_test_data\manual\pngs';
end
...
% Process each image using preprocessing
